  ...
  static _createLevel2() {
    return {
      ...
      platforms: [
        ...
        { x: 100, y: 400, w: 110, h: 14 },
        { x: 300, y: 350, w: 90, h: 14 },
        { x: 480, y: 390, w: 100, h: 14 },
        { x: 650, y: 330, w: 100, h: 14 },
        { x: 830, y: 370, w: 90, h: 14 },
        { x: 980, y: 310, w: 100, h: 14 },
        { x: 1130, y: 390, w: 110, h: 14 },
      ],
      anchors: [
        { x: 150, y: 300 },
        { x: 400, y: 280 },
      ...
      puzzleElements: [
        ...
        },
        {
          ...
          x: 1240,
          y: 500,
          config: { id: 'l2_door1', targetIds: ['l2_sw1'] },
        },
      ],
      decorations: [
        { type: 'crystal', x: 30, y: 490, size: 18 },
        { type: 'crystal', x: 350, y: 490, size: 15 },
        { type: 'crystal', x: 780, y: 490, size: 20 },
        { type: 'crystal', x: 1100, y: 490, size: 16 },
        { type: 'glowOrb', x: 180, y: 280, size: 7, color: 'cyan' },
        { type: 'glowOrb', x: 500, y: 240, size: 9, color: 'white' },
        { type: 'glowOrb', x: 750, y: 260, size: 6, color: 'cyan' },
        { type: 'glowOrb', x: 1050, y: 230, size: 8, color: 'white' },
  ...
  static _createLevel3() {
    return {
      ...
      platforms: [
        ...
        { x: 920, y: 500, w: 360, h: 40 },
        { x: 80, y: 400, w: 80, h: 14 },
        { x: 260, y: 350, w: 70, h: 14 },
        { x: 440, y: 390, w: 80, h: 14 },
        { x: 620, y: 330, w: 70, h: 14 },
        { x: 820, y: 370, w: 80, h: 14 },
        { x: 1000, y: 300, w: 70, h: 14 },
        { x: 1150, y: 400, w: 90, h: 14 },
      ],
      anchors: [
        { x: 120, y: 320 },
      ...
      decorations: [
        { type: 'crystal', x: 40, y: 490, size: 16 },
        { type: 'crystal', x: 550, y: 490, size: 14 },
        { type: 'crystal', x: 980, y: 490, size: 18 },
        { type: 'glowOrb', x: 200, y: 260, size: 7, color: 'orange' },
        { type: 'glowOrb', x: 600, y: 240, size: 6, color: 'red' },
        { type: 'glowOrb', x: 900, y: 220, size: 8, color: 'orange' },
  ...
  static _createLevel4() {
    return {
      ...
      platforms: [
        ...
        { x: 60, y: 390, w: 60, h: 14 },
        { x: 250, y: 340, w: 50, h: 14 },
        { x: 450, y: 380, w: 60, h: 14 },
        { x: 650, y: 320, w: 50, h: 14 },
        { x: 900, y: 370, w: 60, h: 14 },
        { x: 1100, y: 410, w: 70, h: 14 },
      ],
      anchors: [
        { x: 100, y: 340 },
        { x: 470, y: 350 },
      ...
      puzzleElements: [
        ...
        },
        {
          ...
          x: 1240,
          y: 500,
          config: { id: 'l4_door1', targetIds: ['l4_sw1'] },
        },
      ],
      decorations: [
        { type: 'crystal', x: 30, y: 490, size: 12 },
        { type: 'crystal', x: 750, y: 490, size: 10 },
        { type: 'glowOrb', x: 300, y: 260, size: 5, color: 'red' },
